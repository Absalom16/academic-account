    ...
    <div class="hero-content display-table">
      <div class="table-cell">
        <div class="container">
          ...
          <p class="hero-subtitle">You have successfully registered, please pay an activation fee to activate your account.</p>
           <p class="pt-3"><a class="btn btn-primary btn js-scroll px-4" href="#about" role="button">pay</a></p>
        </div>
      </div>
    </div>
