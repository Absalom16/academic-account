    ...
    <div class="hero-content display-table">
      <div class="table-cell">
        <div class="container">
          ...
          <p class="pt-3">
            <a class="btn btn-primary btn js-scroll px-4" href="admin_activate_account.php" role="button">Activate accounts</a>
            <a class="btn btn-primary btn js-scroll px-4" href="file_upload.php" role="button">Post tasks</a>
            <a class="btn btn-primary btn js-scroll px-4" href="#about" role="button">Make payments</a>
          </p>
        </div>
      </div>
    </div>
