  ...
  <div id="hero" class="hero route bg-image" style="background-image: url(hero-bg.jpg)">
   ...
   <?php
    ...
    if(isset($_POST['submit'])){
        ...
        $query = "INSERT INTO filedownload(filename,upload_date) VALUES ('$fileName', NOW())";
   ...
   <p class="pt-3">
            <a class="btn btn-primary btn js-scroll px-4" href="view_files.php" role="button">View uploaded tasks</a>
          </p>
        </div>
      </div>
    </div>
