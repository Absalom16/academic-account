    ...
    <div class="hero-content display-table">
      <div class="table-cell">
        <div class="container">
          ...
          <p class="pt-3">
            <a class="btn btn-primary btn js-scroll px-4" href="download.php" role="button">Tasks</a>
            <a class="btn btn-primary btn js-scroll px-4" href="#about" role="button">Payments</a>
          </p>
        </div>
      </div>
    </div>
